...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'ai_timeout', 'group' => 'ai_assistant', 'value' => '60', 'type' => 'string', 'description' => 'Batas waktu tunggu respons AI (detik). Naikkan (mis. 90-120) untuk model besar/reasoning yang lambat seperti deepseek-v4-pro atau nemotron-550b.'],
            ['key' => 'ai_max_tokens', 'group' => 'ai_assistant', 'value' => '4096', 'type' => 'string', 'description' => 'Batas panjang jawaban (token). Naikkan (mis. 16384) bila memakai model reasoning seperti nemotron/deepseek-thinking; turunkan untuk hemat.'],
            ['key' => 'ai_extra_params', 'group' => 'ai_assistant', 'value' => '', 'type' => 'text', 'description' => 'LANJUTAN (opsional): param JSON khusus-model digabung ke request, mis. {"top_p":0.95,"chat_template_kwargs":{"thinking":false}}. Kosongkan jika tidak perlu. Salah format = diabaikan.'],
